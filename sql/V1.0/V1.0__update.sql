...
INSERT INTO EAM.SYS_DICT
(CODESET_CODE, ITEM_CODE, ITEM_CNAME, ITEM_ENAME, REMARK, ITEM_STATUS, SORT_ID, STATUS, REC_CREATOR, REC_CREATE_TIME, REC_REVISOR, REC_REVISE_TIME, ARCHIVE_FLAG, PROJECT_NAME, SUB_CODESET_CODE)
VALUES('dm.faultFollowStatus', '30', '待审核', ' ', ' ', ' ', ' ', '1', 'admin', '20240510144600', ' ', ' ', ' ', 'WZPLAT', ' ');
INSERT INTO EAM.SYS_DICT
(CODESET_CODE, ITEM_CODE, ITEM_CNAME, ITEM_ENAME, REMARK, ITEM_STATUS, SORT_ID, STATUS, REC_CREATOR, REC_CREATE_TIME, REC_REVISOR, REC_REVISE_TIME, ARCHIVE_FLAG, PROJECT_NAME, SUB_CODESET_CODE)
...
ALTER TABLE EAM.T_EQUIPMENT MODIFY REC_ID NVARCHAR2(50) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY COMPANY_CODE NVARCHAR2(20) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY COMPANY_NAME NVARCHAR2(50) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY DEPT_CODE NVARCHAR2(20) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY DEPT_NAME NVARCHAR2(50) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY EQUIP_CODE NVARCHAR2(20) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY EQUIP_NAME NVARCHAR2(200) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY MAJOR_CODE NVARCHAR2(20) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY MAJOR_NAME NVARCHAR2(50) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY SYSTEM_CODE NVARCHAR2(20) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY SYSTEM_NAME NVARCHAR2(50) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY EQUIP_TYPE_CODE NVARCHAR2(20) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY EQUIP_TYPE_NAME NVARCHAR2(50) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY SPECIAL_EQUIP_FLAG NVARCHAR2(2) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY DELETE_FLAG NVARCHAR2(1) DEFAULT 0  NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY REC_CREATOR NVARCHAR2(20) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY REC_CREATE_TIME NVARCHAR2(20) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY IN_ACCOUNT_TIME NVARCHAR2(20) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY START_USE_DATE NVARCHAR2(20) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY USE_LINE_NO NVARCHAR2(20) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY USE_LINE_NAME NVARCHAR2(20) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY USE_SEG_NO NVARCHAR2(20) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY USE_SEG_NAME NVARCHAR2(20) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY POSITION1_CODE NVARCHAR2(12) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY POSITION1_NAME NVARCHAR2(200) NOT NULL;
ALTER TABLE EAM.T_EQUIPMENT MODIFY APPROVAL_STATUS NVARCHAR2(2) NOT NULL;
