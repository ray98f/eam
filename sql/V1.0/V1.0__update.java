...
UPDATE SYS_DICT SET
ITEM_ENAME=REPLACE(ITEM_ENAME, '/eam/', '/eam-s2/')
WHERE CODESET_CODE ='dm.import.template';

CREATE TABLE EAM.T_USER_STATION (
	REC_ID VARCHAR2(100),
...
ALTER TABLE EAM.T_FAULT_INFO ADD REC_STATION VARCHAR2(100);
